<?php
require_once(dirname(_DIR_) . "/classes/autoload.php");
...
<!DOCTYPE html>
		<html lang="en-US">
			...
			<head>
				...
				<!--services-->
				<script src="angular/services/activation-service.js"></script><!-- more angular controllers as we create the views -->
